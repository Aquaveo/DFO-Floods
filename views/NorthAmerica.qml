...
Page {
    ...
    property Point currentPositionPoint: Point {x: -100.005218; y: 38.411692; spatialReference: SpatialReference.createWgs84()}

    property real scaleFactor: AppFramework.displayScaleFactor
    property url wms3dayServiceUrl: "http://floodobservatory.colorado.edu/geoserver/NA_3day_rs/wms?service=wms&request=getCapabilities";
    property url wms2wkServiceUrl: "http://floodobservatory.colorado.edu/geoserver/NA_2wk_rs/wms?service=wms&request=getCapabilities";
    property url wmsJanServiceUrl: "http://floodobservatory.colorado.edu/geoserver/DFO_rs_Jan_till_current_NA/wms?service=wms&request=getCapabilities";
