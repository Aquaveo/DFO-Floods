...
Page {
    ...
    property url wms3dayServiceUrl: "http://floodobservatory.colorado.edu/geoserver/EU_3day_rs/wms?service=wms&request=getCapabilities";
    property url wms2wkServiceUrl: "http://floodobservatory.colorado.edu/geoserver/EU_2wk_rs/wms?service=wms&request=getCapabilities";
    property url wmsJanServiceUrl: "http://floodobservatory.colorado.edu/geoserver/DFO_rs_Jan_till_current_EU/wms?service=wms&request=getCapabilities";
    ...
    property url wmsHistWServiceUrl: "http://floodobservatory.colorado.edu/geoserver/MOD_history_EU/wms?service=wms&request=getCapabilities";
    property url wmsEventServiceUrl: "http://floodobservatory.colorado.edu/geoserver/Events_EU/wms?service=wms&request=getCapabilities";
    property url wmsWorldPopServiceUrl: "http://floodobservatory.colorado.edu/geoserver/EU_population/wms?service=wms&request=getCapabilities";
        ...
        function createWmsLayer() {
            ...
            serviceFF.loadStatusChanged.connect(function() {
                if (serviceFF.loadStatus === Enums.LoadStatusLoaded) {
                    ...
                    suggestedListM.append(layerInfos[0].sublayerInfos[4]);
                    servicePop.load();
